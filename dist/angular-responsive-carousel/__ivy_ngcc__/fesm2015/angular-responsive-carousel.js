...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularResponsiveCarouselService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
AngularResponsiveCarouselComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: AngularResponsiveCarouselComponent, selectors: [["lib-angular-responsive-carousel"]], decls: 2, vars: 0, template: function AngularResponsiveCarouselComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelementStart(0, "p");
        ɵngcc0.ɵɵtext(1, " angular-responsive-carousel works! ");
        ɵngcc0.ɵɵelementEnd();
    } }, encapsulation: 2 });
AngularResponsiveCarouselComponent.ctorParameters = () => [];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularResponsiveCarouselComponent, [{
        type: Component,
        args: [{
...
IvyCarouselModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: IvyCarouselModule });
IvyCarouselModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function IvyCarouselModule_Factory(t) { return new (t || IvyCarouselModule)(); }, providers: [], imports: [[
            CommonModule
        ]] });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(IvyCarouselModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    CarouselComponent
...
AngularResponsiveCarouselModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AngularResponsiveCarouselModule });
AngularResponsiveCarouselModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function AngularResponsiveCarouselModule_Factory(t) { return new (t || AngularResponsiveCarouselModule)(); }, imports: [[
            IvyCarouselModule
        ], IvyCarouselModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AngularResponsiveCarouselModule, { declarations: [AngularResponsiveCarouselComponent], imports: [IvyCarouselModule], exports: [AngularResponsiveCarouselComponent, IvyCarouselModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(AngularResponsiveCarouselModule, [{
        type: NgModule,
        args: [{
